	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
				...
				<li class="active"><a href='${pageContext.request.getContextPath()}/new/team'><span>科研团队</span></a></li>
...
<div class="footer">
	...
	<div class="content">
		<h2>团队介绍</h2>
		<h3 style="color: #202020; font-size:1.6em">教师:
  ...
  <div class="box1">
   ...
   <div class="box1">
	...
	<div class="box1">
    <h4 class="btm" style="font-size: 1.4em">硕士生</h4>
